...
# Test to launch (exec)
/Users/alvarocorrochano/bin/.pyenv/bin/python3 run_jacobi.py $size 100 $number_exec fp16 cpu
...
echo " Running the jacobi model..."
# Test to launch (exec)
/Users/alvarocorrochano/bin/.pyenv/bin/python3 run_jacobi.py $size 100 $number_exec fp32 cpu
...
echo " Running the jacobi model..."
# Test to launch (exec)
/Users/alvarocorrochano/bin/.pyenv/bin/python3 run_jacobi.py $size 100 $number_exec fp16 gpu
...
echo " Running the jacobi model..."
# Test to launch (exec)
/Users/alvarocorrochano/bin/.pyenv/bin/python3 run_jacobi.py $size 100 $number_exec fp32 gpu
...
echo " Running the jacobi model..."
# Test to launch (exec)
/Users/alvarocorrochano/bin/.pyenv/bin/python3 run_jacobi.py $size 100 $number_exec fp16 ane
...
echo " Running the jacobi model..."
# Test to launch (exec)
/Users/alvarocorrochano/bin/.pyenv/bin/python3 run_jacobi.py $size 100 $number_exec fp32 ane
