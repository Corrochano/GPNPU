...
echo " Running the matmul model..."
# Test to launch (exec)
/Users/alvarocorrochano/bin/.pyenv/bin/python3 run_matmul.py $size $number_exec fp32 cpu
...
echo " Running the matmul model..."
# Test to launch (exec)
/Users/alvarocorrochano/bin/.pyenv/bin/python3 run_matmul.py $size $number_exec fp16 gpu
...
echo " Running the matmul model..."
# Test to launch (exec)
/Users/alvarocorrochano/bin/.pyenv/bin/python3 run_matmul.py $size $number_exec fp32 gpu
...
echo " Running the matmul model..."
# Test to launch (exec)
/Users/alvarocorrochano/bin/.pyenv/bin/python3 run_matmul.py $size $number_exec fp16 ane
...
echo " Running the matmul model..."
# Test to launch (exec)
/Users/alvarocorrochano/bin/.pyenv/bin/python3 run_matmul.py $size $number_exec fp32 ane
