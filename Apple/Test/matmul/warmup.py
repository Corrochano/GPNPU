...
def main(device):
    ...
    if device == "ane":
        wu_model = ct.models.MLModel('matmulfp16WA.mlpackage', compute_units=ct.ComputeUnit.CPU_AND_NE)
    elif device == "gpu":
        wu_model = ct.models.MLModel('matmulfp16WA.mlpackage', compute_units=ct.ComputeUnit.CPU_AND_GPU)
    elif device == "cpu":
        wu_model = ct.models.MLModel('matmulfp16WA.mlpackage', compute_units=ct.ComputeUnit.CPU_ONLY)
    elif device == "all":
        wu_model = ct.models.MLModel('matmulfp16WA.mlpackage', compute_units=ct.ComputeUnit.ALL)
