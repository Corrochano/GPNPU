...
# Test to launch (exec)
/Users/alvarocorrochano/bin/.pyenv/bin/python3 runYolo.py $number_exec cpu
...
echo " Running the matmul model..."
# Test to launch (exec)
/Users/alvarocorrochano/bin/.pyenv/bin/python3 runYolo.py $number_exec gpu
...
echo " Running the matmul model..."
# Test to launch (exec)
/Users/alvarocorrochano/bin/.pyenv/bin/python3 runYolo.py $number_exec ane
